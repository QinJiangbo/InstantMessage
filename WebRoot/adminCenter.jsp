	...
	<div class="container">
		<div class="row clearfix">
			<div class="col-md-12 column">
				<div
					style="font-family:cursive;font-size:100px;margin-left:200px;color:#0055ff">RR
					Chat Admin</div>
				...
				<div class="myMessageStyle">
					<form class="form-horizontal"
						action="messageAction!replyMessage.do" method="post">
						<c:forEach items="${messageList }" var="row">
							<div>
								<div class="mystyle">
									<strong>Sender:</strong> ${row.nickname }
								</div>
								<div class="mystyle">
									...
									<c:when test="${empty reply}">
										...
										<div class="mystyle" style="margin-top:10px">
											...
											<div class="form-group">
												...
												<input type="hidden" value="${row.messageID}"
													name="messageID" />
											</div>
										</div>
									</c:when>
								...
								<hr
									style="border: 1.5px solid purple;margin-top:15px;margin-bottom:0px" />
							</div>
						</c:forEach>
						<div class="col-sm-offset-2 col-sm-10">
							<button type="submit" class="btn btn-success"
								style="width:160px;float:right;margin-top:20px;margin-right:-15px">One
								Key Reply</button>
						</div>
					</form>
				</div>
